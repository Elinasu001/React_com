...
<%
    ...
    String releaseDate = "2024-04-18T00_42_11.216Z";
    String releaseYYMMDD = "240418";
	...
	//vpcgUrl = "../vpcg/vpcg-dev.js?" + releaseDate;
%>
...
<% } %>
        ...
        //Delfino4HtmlConfig.certpinServerUrl = 'https://192.168.1.4:8080/CertPinServer';
		Delfino4HtmlConfig.certpinServerUrl = location.origin + '/CertPinServer';
