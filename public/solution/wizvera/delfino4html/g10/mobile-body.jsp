                ...
                <div class="vpcg_section_user_auth vpcg_section_right_on">
                    <form class='formData' name="vpcg_formLogin" onsubmit="return false;">
                        ...
                        <div class="vpcg_inputfield birthday">
                            <input type="tel" class="vpcg_login_data vpcg_user_birthday" name="birthday" maxlength="14" placeholder="생년월일 입력 (1985 / 01 / 30)" aria-label="생년월일 8자리 입력"></input>
                            <label aria-hidden=true></label>
                        </div>
                        <div class="vpcg_inputfield phone">
                            <input type="tel" class="vpcg_login_data vpcg_user_phone" name="phone" maxlength="17" placeholder="휴대폰 번호 입력" aria-label="휴대폰번호 입력"></input>
                            <label aria-hidden=true></label>
                        </div>
						<div class="vpcg_terms">
							<div class="all_terms">
								<div class="all_terms_check" role="checkbox" tabindex="-1" aria-labelledby="vpcg_all_terms_check">
									<input class="vpcg_all_terms_check" id="vpcg_all_terms_check" type="checkbox" aria-label="필수약관 전체동의" />
							...
							<div class="service_terms">
								...
								<a class="service_terms_view termView" id="serviceView" target="_blank" role="button" tabindex="-1" aria-label="서비스이용 약관보기">보기></a>
							</div>
							<div class="privacy_terms">
								...
								<a class="privacy_terms_view termView" id="privacyView" target="_blank" role="button" tabindex="-1" aria-label="개인정보 이용동의 약관보기">보기></a>
							</div>
							<div class="info_terms">
								...
								<a class="info_terms_view termView" id="infoView" target="_blank" role="button" tabindex="-1" aria-label="제삼자 정보제공동의 약관보기">보기></a>
							</div>
							<div class="pii_terms">
								...
								<a class="pii_terms_view termView" id="piiView" target="_blank" role="button" tabindex="-1" aria-label="고유식별정보처리동의약관 보기">보기></a>
							</div>
							<div class="terms_view" aria-hidden="true"><iframe id="vpcg_terms_view"></iframe><span class="vpcg_btn_terms_close" role="button" aria-label="약관보기 창 닫기" tabindex="-1"></span></div>
						</div>
