...
<b>가. 용어의 정의</b>
1. 인증사업자 : <%=providers%> 등 간편인증서비스를 제공하는 사업자

<b>나. 제3자 제공에 관한 사항</b>
1. 개인정보를 제공받는 자 : 인증사업자
2. 제공받는 자의 개인정보 이용목적 : 간편인증을 이용한 본인인증 또는 전자서명
3. 제공하는 개인정보 항목 : 성명, 생년월일, 휴대폰번호
4. 제공받는 자의 보유 및 이용기간 : 본인인증 또는 전자서명 후 즉시 파기
위 개인정보를 제3자에게 제공하는 것에 대한 동의를 거부할 수 있습니다. 단, 동의를 거부하는 경우 간편인증서비스 이용이 제한될 수 있습니다.
</pre>
</body>
</html>
